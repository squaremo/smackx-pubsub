...
public class OwnerUseCases extends SingleUserTestCase
{
	...
	{
		Node node = getManager().createNode();
		assertNotNull(node);
	...
	public void testCreateNamedNode() throws Exception
	{
		...
		Node node = getManager().createNode(id);
	...
	public void testCreateConfiguredNode() throws Exception
	{
		...
		Node node = getManager().createNode(id, form);
	...
	public void testCreateAndUpdateConfiguredNode() throws Exception
	{
		...
		Node myNode = getManager().createNode(id, form);
	...
	{
		Node myNode = getManager().createNode();
	...
	{
		Node node = getPubnode(getManager(), true, false);
